...
// **************************************** Port A *****************************************
// **************************************** Pin 2 ******************************************
		GPIOA->CRL &= ~GPIO_CRL_CNF2; // Clear CNF bits
		GPIOA->CRL |= GPIO_CRL_CNF2_1; // Set to Alternate function output Push-pull
		GPIOA->CRL |= GPIO_CRL_MODE2_0 | GPIO_CRL_MODE2_1; // Set to max speed 50 MHz
	
// **************************************** Port A *****************************************
// **************************************** Pin 3 ******************************************
	GPIOA->CRL &= ~GPIO_CRL_CNF3; // Clear CNF bits
	GPIOA->CRL |= GPIO_CRL_CNF3_0; // Set to Input with pull-up / pull-down
